...
CREATE TABLE sentences AS
  SELECT "The two siblings, "|| sib1 || " plus " || sib2 || " have the same size: "|| a.size from siblings,size_of_dogs as a, size_of_dogs as b where sib1 = a.name and sib2 = b.name and a.size = b.size;
